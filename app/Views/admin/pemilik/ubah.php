...
<div class="page-inner">
  <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
    <div>
      ...
      <h6 class="op-7 mb-2">Ubah Data Pemilik</h6>
    </div>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Form Ubah Pemilik</h4>
        </div>
        <div class="card-body">
          <form action="<?= base_url('Pemilik/update'); ?>" method="post">
            <?= csrf_field(); ?>
            <div class="form-group">
              <label for="nama">Nama Pemilik</label>
              <input type="text" class="form-control" id="nama" name="Nama" value="<?= $item['Nama'] ?>" placeholder="Masukkan nama dokter" required>
              <input type="hidden" class="form-control" id="Pemilik_id" name="Pemilik_id" value="<?= $item['Pemilik_id'] ?>">
            </div>
            <div class="form-group">
