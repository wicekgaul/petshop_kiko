...
<div class="page-inner">
  <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
    <div>
      ...
      <h6 class="op-7 mb-2">Ubah Data Obat</h6>
    </div>
  </div>
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Form Ubah Obat</h4>
        </div>
        <div class="card-body">
          <form action="<?= base_url('Obat/update'); ?>" method="post">
            ...
            <div class="form-group">
              ...
              <input type="hidden" class="form-control" id="Obat_id" name="Obat_id" value="<?= $item['Obat_id'] ?>">
            </div>
            <div class="form-group">
