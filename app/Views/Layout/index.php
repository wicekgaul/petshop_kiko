...
<title><?= $title; ?></title>
    ...
    <link
      rel="icon"
      href="<?= base_url()?>img/kaiadmin/favicon.ico"
      type="image/x-icon"
    />
    ...
    <script>
      WebFont.load({
        ...
        custom: {
          ...
          urls: ["<?= base_url()?>css/fonts.min.css"],
        },
        active: function () {
    ...
    <link rel="stylesheet" href="<?= base_url()?>css/plugins.min.css" />
    <link rel="stylesheet" href="<?= base_url()?>css/kaiadmin.min.css" />
